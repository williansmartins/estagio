...
class SearchTransactionsByDateInterval
{
    ...
    public static function main()
    {
        ...
        $initialDate = '2015-01-09T08:50';
        $finalDate = '2015-01-13T00:40';
        ...
        try {
             ...
             */
            // $credentials = new PagSeguroAccountCredentials("professorwillians@gmail.com",
            //    "581746CFDE8F4E31B08B40DF82235BF3");
            $credentials = PagSeguroConfig::getAccountCredentials();
    ...
    public static function printResult(PagSeguroTransactionSearchResult $result, $initialDate, $finalDate)
    {
        ...
        if (is_array($transactions) && count($transactions) > 0) {
            foreach ($transactions as $key => $transactionSummary) {
                ...
                echo $transactionSummary->getStatus()->getTypeFromValue();
                echo "<hr>";
            }
        }
    }
